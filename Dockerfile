...
WORKDIR /app
COPY --from=builder --chown=nodeuser:nodeuser /work/build ./build
COPY --from=builder --chown=nodeuser:nodeuser /work/server.js ./server.js
COPY --from=builder --chown=nodeuser:nodeuser /work/node_modules ./node_modules
